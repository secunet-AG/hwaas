CREATE TABLE bmr_image_tag_map(
    ...
    FOREIGN KEY(bmr_image_metadata_id) REFERENCES bmr_image_metadatas(id) ON DELETE CASCADE,
    FOREIGN KEY(bmr_image_tag_id) REFERENCES bmr_image_tags(id) ON DELETE CASCADE
)
