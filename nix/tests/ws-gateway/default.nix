    ...
    { pkgs, config, ... }:
    {
      ...
      packages = {
        ...
        ws-gateway-test-many-clients-scenario-debug =
          (config.checks.ws-gateway-test-many-clients-scenario.override { debugging = true; }).driverInteractive;
        ws-gateway-test-clients-and-suts-scenario-debug =
          (config.checks.ws-gateway-test-clients-and-suts-scenario.override { debugging = true; }).driverInteractive;
      };
    };
}
